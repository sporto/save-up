...
module ApiPub.Object.RequestPasswordResetResponse exposing (errors, selection, success, token)
...
token : Field (Maybe String) ApiPub.Object.RequestPasswordResetResponse
token =
