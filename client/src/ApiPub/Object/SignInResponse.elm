...
module ApiPub.Object.SignInResponse exposing (errors, jwt, success)
...
success : SelectionSet Bool ApiPub.Object.SignInResponse
success =
    Object.selectionForField "Bool" "success" [] Decode.bool


errors : SelectionSet decodesTo ApiPub.Object.MutationError -> SelectionSet (List decodesTo) ApiPub.Object.SignInResponse
errors object_ =
    Object.selectionForCompositeField "errors" [] object_ (identity >> Decode.list)


jwt : SelectionSet (Maybe String) ApiPub.Object.SignInResponse
jwt =
